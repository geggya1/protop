...
const styles = StyleSheet.create({
  ...
  sceneTabTxt: { fontSize: 13, color: colors.text, fontWeight: '600' },
  ...
  secondaryBtnTxt: { color: '#5C4033', fontWeight: '600' },
  dangerBtn: {
    paddingHorizontal: 14,
    paddingVertical: 8,
    borderRadius: 10,
  ...
  dangerBtnTxt: { color: '#a11', fontWeight: '600' },
  sectionTitle: {
    fontSize: 16,
    fontWeight: '700',
    color: colors.text,
  ...
  deleteLinkTxt: { color: '#a11', fontWeight: '600' },
});
