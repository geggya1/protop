...
import { submitTeamJoinRequest, normalizeJoinCode } from '../../src/utils/teams';
...
export default function TeamJoinScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Forespørsel sendt',
        `Du har bedt om å bli med i «${result.teamName}» for ${firstName} ${lastName}. En administrator må godkjenne før dere slipper inn.`,
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      <View style={styles.head}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.title}>Bli med i lag</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
        <Text style={styles.lead}>
          Skriv inn unik lagkode fra trener/admin, og barnets fulle navn. Administrator må godkjenne forespørselen.
        </Text>
        <Text style={styles.label}>Lagkode</Text>
        <TextInput
          style={styles.input}
          value={code}
          ...
          maxLength={8}
        />
        <Text style={styles.label}>Barnets fornavn</Text>
        <TextInput
          style={styles.input}
          value={firstName}
          ...
          placeholderTextColor={c.muted}
        />
        <Text style={styles.label}>Barnets etternavn</Text>
        <TextInput
          style={styles.input}
          value={lastName}
