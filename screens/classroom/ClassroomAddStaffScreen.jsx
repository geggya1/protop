...
const styles = StyleSheet.create({
  ...
  modeSub: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 2 },
  ...
  roleTxt: { color: c.muted, fontWeight: '400', fontSize: 12 },
  ...
  doneLead: { color: c.ink, fontWeight: '400', fontSize: 15, textAlign: 'center' },
});
