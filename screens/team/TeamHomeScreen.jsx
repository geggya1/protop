...
const styles = StyleSheet.create({
  ...
  welcomeKicker: {
    fontSize: 11, fontWeight: '400', letterSpacing: 1.1,
    color: c.tint, textTransform: 'uppercase',
  },
  welcomeTitle: { marginTop: 4, color: c.ink, fontWeight: '400', fontSize: 24 },
  welcomeSub: { marginTop: 6, color: c.muted, fontWeight: '400', fontSize: 14, lineHeight: 20 },
  ...
  quickTxt: { color: c.ink, fontWeight: '400', fontSize: 12 },
  listHead: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10,
  },
  listHeadTxt: { color: c.ink, fontWeight: '400', fontSize: 16 },
  listHeadLink: { color: c.brand, fontWeight: '400', fontSize: 14 },
  weekBlock: { marginBottom: 16 },
  weekLabel: { color: c.muted, fontWeight: '400', fontSize: 12, marginBottom: 8, letterSpacing: 0.6 },
  eventCard: {
  ...
  month: { color: c.muted, fontWeight: '400', fontSize: 11 },
  day: { color: c.ink, fontWeight: '400', fontSize: 22, lineHeight: 26 },
  eventBody: { flex: 1, minWidth: 0 },
  eventTitle: { color: c.ink, fontWeight: '400', fontSize: 15 },
  eventTime: { color: c.ink, fontWeight: '400', fontSize: 13, marginTop: 2 },
  ...
  emptySub: { color: c.muted, textAlign: 'center', fontWeight: '400', fontSize: 13, lineHeight: 18, paddingHorizontal: 24 },
  emptyBtn: {
    alignSelf: 'flex-start',
    marginTop: 8, backgroundColor: c.brand, borderRadius: 14,
    paddingHorizontal: 18, paddingVertical: 12,
  },
  emptyBtnTxt: { color: '#fff', fontWeight: '400', fontSize: 14 },
});
