...
const styles = StyleSheet.create({
  ...
  planTitle: { fontWeight: '900', fontSize: 18, color: colors.ink },
  planTitleDesk: { ...deskType.title, fontSize: 16 },
  planPrice: { marginTop: 4, fontWeight: '800', fontSize: 15, color: colors.ink },
  ...
  methodLabel: { flex: 1, fontWeight: '800', fontSize: 15, color: colors.ink },
  ...
  platformTag: { fontSize: 11, fontWeight: '700', color: colors.muted },
  badge: {
    borderRadius: 999,
    paddingHorizontal: 8,
    paddingVertical: 2,
  ...
  brandChipTxt: { fontSize: 11, fontWeight: '700', color: colors.ink },
  cta: {
    marginTop: 16,
  ...
  error: { marginTop: 10, color: colors.danger, fontWeight: '700', fontSize: 13 },
  notice: { marginTop: 10, color: colors.success, fontWeight: '700', fontSize: 13, lineHeight: 18 },
  footnote: {
    marginTop: 14,
    color: colors.muted,
    fontWeight: '600',
