...
const styles = StyleSheet.create({
  ...
  change: { fontWeight: '400', fontSize: 12, color: colors.brand },
  nowRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  nowTemp: { fontWeight: '400', fontSize: 28, color: colors.ink },
  nowCond: { flex: 1, fontWeight: '400', fontSize: 14, color: colors.ink },
  tabRow: {
    flexDirection: 'row',
    gap: 8,
    marginBottom: 12,
  ...
  tabTxt: { fontWeight: '400', fontSize: 13, color: colors.muted },
  ...
  dayLbl: { fontWeight: '400', fontSize: 10, color: colors.muted, textTransform: 'uppercase', marginBottom: 4 },
  dayHead: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 2 },
  dayTemp: { fontWeight: '400', fontSize: 14, color: colors.ink },
