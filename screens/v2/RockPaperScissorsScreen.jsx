...
function makeStyles(simpleUi, contentMax, layout) {
  return StyleSheet.create({
    ...
    roundLabel: { textAlign: 'center', color: colors.ink, fontWeight: '800', fontSize: 16 },
    wait: { textAlign: 'center', color: colors.muted, fontWeight: '600', marginVertical: 12, fontSize: 15 },
    prompt: {
      textAlign: 'center', fontWeight: '800', fontSize: simpleUi ? 24 : 20,
    ...
    choiceEmoji: {},
    choiceLabel: { fontWeight: '800', marginTop: 8, color: colors.ink, fontSize: simpleUi ? 17 : 14 },
    ...
    revealEmoji: {},
    revealName: { fontWeight: '700', fontSize: 13, marginTop: 6, color: colors.ink },
    finished: { textAlign: 'center', fontWeight: '800', color: colors.success, fontSize: 18 },
    section: {
      marginTop: 18, marginBottom: 6, color: colors.muted, fontWeight: '600',
    ...
    inviteStatus: { fontWeight: '600', color: colors.muted, fontSize: 13 },
    ...
    scoreRank: { width: 28, fontWeight: '700', color: colors.muted, fontSize: 16 },
    scoreName: { flex: 1, fontWeight: '600', color: colors.ink, fontSize: 15 },
    scorePts: { fontWeight: '800', color: colors.brand, fontSize: 18 },
    primary: {
