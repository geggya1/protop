...
const styles = StyleSheet.create({
  ...
  welcomeKicker: { fontSize: 11, fontWeight: '400', textTransform: 'uppercase', letterSpacing: 0.8 },
  welcomeTitle: { fontSize: 22, fontWeight: '400', marginTop: 4 },
  ...
  quickTxt: { fontSize: 11, fontWeight: '400', textAlign: 'center' },
  ...
  sectionLink: { fontSize: 13, fontWeight: '400' },
  empty: { borderRadius: 16, padding: 24, alignItems: 'center', gap: 8, borderWidth: 1 },
  emptyTxt: { fontSize: 14, textAlign: 'center' },
  weekBlock: { gap: 8 },
  weekLabel: { fontSize: 12, fontWeight: '400', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  eventDay: { fontSize: 18, fontWeight: '400', lineHeight: 20 },
  eventMon: { fontSize: 9, fontWeight: '400' },
  eventTitle: { fontSize: 15, fontWeight: '400' },
  eventSub: { fontSize: 12, marginTop: 2 },
  rsvpHint: { fontSize: 11, fontWeight: '400', marginTop: 4 },
});
