...
const styles = StyleSheet.create({
  ...
  title: { color: c.ink, fontWeight: '900', fontSize: 22, marginTop: 2 },
  addBtn: {
  ...
  navTxt: { fontSize: 26, fontWeight: '800', color: c.brand, marginTop: -2 },
  navTitle: {
  ...
  weekLbl: {
    flex: 1, textAlign: 'center', fontWeight: '800', color: c.muted,
  ...
  dayTxt: { fontWeight: '700', color: c.ink, fontSize: 14 },
  dayOnTxt: { color: '#fff' },
  ...
  dotSpacer: { height: 7 },
  section: {
    color: c.ink, fontWeight: '800', fontSize: 15, marginBottom: 8,
  ...
  emptyDayTxt: { color: c.muted, fontWeight: '600', fontSize: 13 },
  emptyLink: { marginTop: 8 },
  emptyLinkTxt: { color: c.brand, fontWeight: '800', fontSize: 13 },
  eventRow: {
  ...
  dateBadgeDay: { color: c.brand, fontWeight: '900', fontSize: 16, lineHeight: 18 },
  dateBadgeMon: { color: c.tint, fontWeight: '700', fontSize: 10, textTransform: 'uppercase' },
});
