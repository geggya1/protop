...
const styles = StyleSheet.create({
  ...
  kicker: { fontSize: 12, fontWeight: '400', letterSpacing: 0.6, color: colors.brand, textTransform: 'uppercase' },
  title: { fontSize: 22, fontWeight: '400', color: colors.ink, marginTop: 4 },
  lead: { marginTop: 8, marginBottom: 8, color: colors.muted, fontWeight: '400', fontSize: 15, lineHeight: 21 },
  row: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    paddingVertical: 14, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.line,
  },
  icon: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  rowTitle: { fontSize: 16, fontWeight: '400', color: colors.ink },
  rowSub: { marginTop: 2, fontSize: 13, fontWeight: '400', color: colors.muted },
  skip: { marginTop: 16, alignItems: 'center', paddingVertical: 12 },
  skipTxt: { color: colors.muted, fontWeight: '400', fontSize: 15 },
});
