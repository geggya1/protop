...
const styles = StyleSheet.create({
  ...
  title: { color: c.ink, fontWeight: '400', fontSize: 18 },
  body: { padding: 16, paddingBottom: 40 },
  hint: { color: c.muted, fontWeight: '400', fontSize: 13, lineHeight: 18, marginBottom: 4 },
  label: { color: c.muted, fontWeight: '400', fontSize: 12, marginBottom: 6, marginTop: 12 },
  input: {
    backgroundColor: c.surface, borderRadius: 12, borderWidth: 1, borderColor: c.line,
    paddingHorizontal: 12, paddingVertical: 12, color: c.ink, fontWeight: '400',
  },
