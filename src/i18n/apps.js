...
export const APPS_TABLE = {
  ...
  team: {
    ...
    switchPlatform: L('Skift organisasjon', 'Switch organisation', 'Skift organisation', 'Byt organisation', 'Vaihda organisaatiota', 'Zmień organizację', 'Cambiar organización', 'Changer d’organisation', 'Organisation wechseln'),
