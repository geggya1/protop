...
const styles = StyleSheet.create({
  ...
  pageSub: { fontSize: 12, fontWeight: '600', color: c.muted, marginTop: 1 },
  composeBtn: {
  ...
  name: { flex: 1, fontWeight: '800', fontSize: 14, color: c.ink },
  time: { fontSize: 11, fontWeight: '600', color: c.muted },
  ...
  empty: { padding: 14, color: c.muted, fontWeight: '600', fontSize: 13, lineHeight: 18 },
  ...
  sheetTitle: { fontWeight: '900', fontSize: 18, color: c.ink },
  sheetLead: { color: c.muted, fontWeight: '600', fontSize: 13, marginTop: 4, marginBottom: 10, lineHeight: 18 },
  sheetHeadRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 8,
  },
  sheetSection: {
    fontSize: 11, fontWeight: '800', color: c.muted, textTransform: 'uppercase', letterSpacing: 0.5,
  },
  multiToggle: { color: c.brand, fontWeight: '800', fontSize: 13 },
  pickRow: {
    flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10,
    borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: c.line,
  },
  pickName: { fontWeight: '800', fontSize: 14, color: c.ink },
  pickSub: { color: c.muted, fontWeight: '600', fontSize: 11, marginTop: 1 },
  startBtn: {
    marginTop: 12, backgroundColor: c.brand, borderRadius: 14, paddingVertical: 14, alignItems: 'center',
  },
  startBtnTxt: { color: '#fff', fontWeight: '900', fontSize: 15 },
  cancelBtn: { marginTop: 8, alignItems: 'center', paddingVertical: 10 },
  cancelTxt: { fontWeight: '800', color: c.muted, fontSize: 14 },
});
