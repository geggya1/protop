...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    color: c.tint, fontWeight: '400', fontSize: 12, textTransform: 'uppercase',
    letterSpacing: 0.5, marginBottom: 8,
  },
  emptySec: { color: c.muted, fontWeight: '400', marginBottom: 8 },
  row: {
  ...
  empty: { color: c.muted, fontWeight: '400', textAlign: 'center', marginTop: 8 },
  ...
  statNum: { color: c.brand, fontWeight: '400', fontSize: 28 },
  statLbl: { color: c.muted, fontWeight: '400', marginTop: 4 },
});
