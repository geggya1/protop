...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '900', color: '#0f1419', marginBottom: 8 },
  lead: { fontSize: 15, fontWeight: '600', color: '#536471', lineHeight: 22, marginBottom: 14 },
  info: { fontSize: 14, fontWeight: '600', color: '#475569', lineHeight: 20, marginBottom: 12 },
  benefit: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginBottom: 10 },
  benefitTxt: { flex: 1, fontSize: 14, fontWeight: '600', color: '#334155', lineHeight: 20 },
  primary: {
    marginTop: 14,
  ...
  secondaryTxt: { color: '#0f1419', fontWeight: '800', fontSize: 15 },
  linkBtn: { marginTop: 12, alignItems: 'center', padding: 6 },
  linkTxt: { color: colors.brand, fontWeight: '800', fontSize: 14 },
  mutedLink: { color: '#94a3b8', fontWeight: '700', fontSize: 13 },
  label: { fontWeight: '800', color: '#0f1419', marginBottom: 6 },
  input: {
    borderWidth: 1,
    borderColor: '#e5e7eb',
    borderRadius: 12,
  ...
  username: { fontWeight: '900', fontSize: 16, color: '#0f1419' },
});
