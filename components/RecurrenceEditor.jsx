...
const styles = StyleSheet.create({
  ...
  formRowLabel: { fontWeight: '400', fontSize: 14, color: colors.ink },
  formRowRight: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  formRowValue: { fontWeight: '400', fontSize: 14, color: colors.muted },
  subLabel: { fontSize: 12, fontWeight: '400', color: colors.muted, textTransform: 'uppercase', marginTop: 4 },
  hint: { color: colors.muted, fontSize: 12, fontWeight: '400', lineHeight: 17 },
  ...
  weekChipTxt: { fontWeight: '400', fontSize: 12, color: colors.ink },
  ...
  sheetTitle: { fontWeight: '400', fontSize: 16, textAlign: 'center', paddingVertical: 12, color: colors.ink },
  sheetRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
  ...
  sheetRowTxt: { fontSize: 16, fontWeight: '400', color: colors.ink },
  sheetCancel: { marginTop: 8, paddingVertical: 14, alignItems: 'center' },
  sheetCancelTxt: { fontWeight: '400', fontSize: 16, color: colors.brand },
  ...
  customDone: { fontWeight: '400', fontSize: 16, color: colors.brand },
  customCard: {
  ...
  customRowLabel: { fontWeight: '400', fontSize: 14, color: colors.ink },
  ...
  intervalPillTxt: { fontWeight: '400', fontSize: 14, color: colors.ink },
  intervalPillTxtOn: { color: colors.brand },
  intervalUnit: { fontWeight: '400', fontSize: 14, color: colors.muted, marginTop: 8 },
});
