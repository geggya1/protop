...
const styles = StyleSheet.create({
  ...
  sub: { color: c.muted, fontWeight: '400', marginTop: 2 },
  notes: { color: c.ink, fontWeight: '400', marginTop: 6 },
  row: { flexDirection: 'row', gap: 16, marginTop: 8 },
  link: { color: c.brand, fontWeight: '400' },
  del: { color: c.danger, fontWeight: '400' },
  ...
  label: { color: c.ink, fontWeight: '400', fontSize: 12, marginBottom: 6 },
