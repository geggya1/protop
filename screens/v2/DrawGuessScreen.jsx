...
function makeStyles(simpleUi, contentMax, layout) {
  return StyleSheet.create({
    ...
    roundLabel: {
      alignSelf: 'center', color: colors.muted, fontWeight: '400', fontSize: 12,
    ...
    secretLabel: { color: colors.muted, fontWeight: '400', fontSize: 13 },
    secretWord: {
      color: colors.ink, fontWeight: '400', fontSize: 28, marginTop: 4, textTransform: 'capitalize',
    },
    secretWordSimple: { fontSize: 34 },
    waitHint: { color: colors.muted, fontWeight: '500', marginTop: 6, textAlign: 'center' },
    prompt: {
      textAlign: 'center', fontWeight: '400', fontSize: simpleUi ? 22 : 18,
    ...
    toolTxt: { fontWeight: '400', color: colors.ink, fontSize: 13 },
    ...
    optionTxt: { fontWeight: '400', color: colors.ink, fontSize: 16, textTransform: 'capitalize' },
    ...
    guessBtnTxt: { color: '#fff', fontWeight: '400', fontSize: 15 },
    inviteBoard: {
    ...
    attemptGuess: { fontWeight: '400', color: colors.ink, textTransform: 'capitalize' },
    attemptHint: { fontWeight: '400', color: colors.muted, minWidth: 72, textAlign: 'right' },
    attemptCorrect: { color: colors.success },
    myAttempt: { fontWeight: '400', color: colors.ink, marginBottom: 4 },
