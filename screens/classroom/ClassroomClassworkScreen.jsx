...
const styles = StyleSheet.create({
  ...
  emptySub: { marginTop: 6, color: c.muted, textAlign: 'center', fontWeight: '600', lineHeight: 18 },
  section: { marginBottom: 16 },
  sectionTitle: {
    color: c.tint, fontWeight: '900', fontSize: 13, textTransform: 'uppercase',
    letterSpacing: 0.6, marginBottom: 8,
  },
  emptySec: { color: c.muted, fontWeight: '600', fontSize: 13, marginBottom: 8 },
  row: {
  ...
  rowType: { color: c.muted, fontWeight: '700', fontSize: 11, textTransform: 'uppercase' },
  rowTitle: { color: c.ink, fontWeight: '800', fontSize: 15, marginTop: 2 },
  ...
  sheetRowTxt: { color: c.ink, fontWeight: '800', fontSize: 16 },
  sheetCancel: { marginTop: 14, alignItems: 'center', paddingVertical: 10 },
  sheetCancelTxt: { color: c.muted, fontWeight: '800' },
  input: {
    borderWidth: 1, borderColor: c.line, borderRadius: 12, paddingHorizontal: 12,
    paddingVertical: 12, color: c.ink, fontWeight: '600', backgroundColor: c.surface2,
  },
});
