...
const styles = StyleSheet.create({
  ...
  codeLabel: { fontSize: 12, fontWeight: '400', textTransform: 'uppercase' },
  code: { fontWeight: '400', fontSize: 36, letterSpacing: 4, marginTop: 8 },
  ...
  linkTxt: { flex: 1, fontWeight: '400', fontSize: 14 },
});
