...
const styles = StyleSheet.create({
  ...
  denied: { marginTop: 24, color: colors.muted, fontWeight: '400', fontSize: 15 },
  section: { marginTop: 18, marginBottom: 10, fontWeight: '400', color: colors.ink, fontSize: 15 },
  empty: { color: colors.muted, fontWeight: '400', lineHeight: 20 },
  label: { fontWeight: '400', color: colors.ink, marginTop: 12, marginBottom: 6, fontSize: 14 },
  subLabel: { fontWeight: '400', color: colors.muted, marginTop: 8, marginBottom: 4, fontSize: 12 },
  ...
  templateTitle: { fontWeight: '400', color: colors.ink, marginTop: 6 },
  ...
  goalTitle: { fontWeight: '400', color: colors.ink, fontSize: 17 },
  goalMeta: { color: colors.muted, fontSize: 12, marginTop: 2, fontWeight: '400' },
  ...
  milestoneIdx: { fontWeight: '400', color: colors.ink },
});
