...
const styles = StyleSheet.create({
  ...
  statNum: { color: c.ink, fontWeight: '400', fontSize: 22 },
  statLbl: { color: c.muted, fontWeight: '400', fontSize: 11, marginTop: 2 },
  ...
  quickTxt: { marginTop: 6, color: c.ink, fontWeight: '400', fontSize: 11 },
  listHead: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8,
  },
  listHeadTxt: { color: c.ink, fontWeight: '400', fontSize: 16 },
  listHeadLink: { color: c.brand, fontWeight: '400', fontSize: 13 },
  empty: {
  ...
  emptySub: { marginTop: 6, color: c.muted, textAlign: 'center', fontWeight: '400', lineHeight: 20 },
  emptyBtn: {
  ...
  slotTitle: { color: c.ink, fontWeight: '400', fontSize: 15 },
  slotMeta: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 2 },
});
