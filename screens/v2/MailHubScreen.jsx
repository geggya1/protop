...
const styles = StyleSheet.create({
  ...
  bannerTxt: { color: '#9a3412', fontWeight: '700', fontSize: 12 },
  ...
  mobileTitle: { fontSize: 20, fontWeight: '700', color: colors.ink, flexShrink: 1 },
  mobileBackTxt: { fontSize: 16, fontWeight: '600', color: colors.brand, flexShrink: 1 },
  ...
  pillTxt: { fontWeight: '700', color: colors.muted, fontSize: 13 },
  ...
  drawerTitle: { fontSize: 18, fontWeight: '700', color: colors.ink, flex: 1 },
  drawerClose: {
  ...
  accountLbl: { flex: 1, fontSize: 12, fontWeight: '700', color: colors.ink },
  grantBtn: { paddingHorizontal: 12, paddingVertical: 6 },
  grantTxt: { color: colors.brand, fontWeight: '800', fontSize: 12 },
  ...
  folderNameOn: { fontWeight: '700', color: colors.brand },
  unread: { fontSize: 11, fontWeight: '800', color: colors.brand },
  listPane: {
  ...
  tabTxt: { fontWeight: '700', color: colors.muted, fontSize: 13 },
  tabTxtOn: { color: colors.brand },
  section: { fontSize: 11, fontWeight: '800', color: colors.muted, paddingHorizontal: 12, paddingTop: 10, paddingBottom: 4 },
  ...
  avatarTxt: { fontSize: 12, fontWeight: '800', color: colors.brand },
  msgTop: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  msgFrom: { flex: 1, fontSize: 13, color: colors.ink },
  msgBold: { fontWeight: '800' },
  msgWhen: { fontSize: 11, color: colors.muted, fontWeight: '600' },
  msgSub: { fontSize: 13, color: colors.brand, fontWeight: '600', marginTop: 1 },
  msgPrev: { fontSize: 12, color: colors.muted, marginTop: 2 },
  readPane: { flex: 1, minWidth: 0, minHeight: 0, zIndex: 1, overflow: 'hidden' },
  readSubject: { fontSize: 20, fontWeight: '700', color: colors.ink, marginBottom: 8 },
  readFrom: { fontSize: 14, fontWeight: '700', color: colors.ink },
  ...
  moreTxt: { color: colors.brand, fontWeight: '700', fontSize: 13 },
});
