...
const styles = StyleSheet.create({
  ...
  titleCompact: { fontSize: 14, fontWeight: '800' },
  hint: { color: colors.muted, fontWeight: '600', fontSize: 12, lineHeight: 17 },
  hintCompact: { fontSize: 11, lineHeight: 15 },
  row: { flexDirection: 'row', gap: 12 },
  stepCol: { flex: 1, gap: 6 },
  stepLabel: { fontWeight: '800', fontSize: 12, color: colors.muted, textTransform: 'uppercase' },
  stepRow: {
  ...
  stepVal: { fontWeight: '900', fontSize: 20, color: colors.ink, minWidth: 28, textAlign: 'center' },
