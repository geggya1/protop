...
const styles = StyleSheet.create({
  ...
  kicker: { color: c.tint, fontWeight: '400', fontSize: 11, textTransform: 'uppercase' },
  title: { color: c.ink, fontWeight: '400', fontSize: 17 },
  body: { padding: 16, paddingBottom: 40 },
  meta: { color: c.muted, fontWeight: '400', fontSize: 12, marginBottom: 8 },
  instructions: { color: c.ink, fontWeight: '400', fontSize: 15, lineHeight: 22, marginBottom: 12 },
  link: {
    flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8,
    backgroundColor: c.brandSoft, borderRadius: 10, padding: 10,
  },
  linkTxt: { flex: 1, color: c.brand, fontWeight: '400', fontSize: 13 },
  box: {
    marginTop: 8, backgroundColor: c.surface, borderRadius: 16, padding: 14,
    borderWidth: 1, borderColor: c.line,
  },
  boxTitle: { color: c.ink, fontWeight: '400', fontSize: 16, marginBottom: 8 },
  status: { color: c.muted, fontWeight: '400', marginBottom: 8 },
  feedback: { color: c.ink, fontWeight: '400', fontSize: 13, lineHeight: 18, marginBottom: 8 },
  input: {
    backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: c.line,
    paddingHorizontal: 12, paddingVertical: 10, color: c.ink, fontWeight: '400', marginBottom: 8,
  },
  ...
  optionTxt: { color: c.ink, fontWeight: '400' },
  primaryBtn: {
  ...
  subName: { color: c.ink, fontWeight: '400', fontSize: 15 },
  subMeta: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 2, marginBottom: 8 },
  gradeRow: { flexDirection: 'row', gap: 8 },
  miniBtn: {
    alignSelf: 'flex-start', backgroundColor: c.brandSoft, borderRadius: 10,
    paddingHorizontal: 12, paddingVertical: 8, marginTop: 4,
  },
  miniTxt: { color: c.brand, fontWeight: '400', fontSize: 12 },
  comment: {
    backgroundColor: c.surface2, borderRadius: 10, padding: 10, marginBottom: 8,
  },
  commentAuthor: { color: c.muted, fontWeight: '400', fontSize: 11, marginBottom: 4 },
  commentBody: { color: c.ink, fontWeight: '400', fontSize: 13, lineHeight: 18 },
  ...
  dangerTxt: { color: c.danger, fontWeight: '400' },
});
