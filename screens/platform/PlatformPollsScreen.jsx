...
const styles = StyleSheet.create({
  ...
  question: { fontSize: 16, fontWeight: '400' },
  author: { fontSize: 12 },
  option: { flexDirection: 'row', justifyContent: 'space-between', padding: 12, borderRadius: 12, borderWidth: 1, borderColor: 'transparent' },
  optionLabel: { fontSize: 14, fontWeight: '400', flex: 1 },
  optionCount: { fontSize: 12, fontWeight: '400' },
  ...
  saveBtn: {
    alignSelf: 'flex-start', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12 },
