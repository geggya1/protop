...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '900', color: colors.ink, marginBottom: 10 },
  ...
  ownBadgeTxt: { color: '#fff', fontWeight: '800', fontSize: 12 },
  systemBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: '#eef6ff', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 14,
  },
  systemBadgeTxt: { color: colors.brand, fontWeight: '800', fontSize: 12 },
  ...
  pillTxt: { fontWeight: '700', fontSize: 12, color: colors.brand },
  linkRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 8,
  },
  linkTxt: { color: colors.brand, fontWeight: '700', flex: 1 },
  ...
  detailLbl: { fontSize: 10, fontWeight: '800', color: colors.muted, textTransform: 'uppercase', marginBottom: 4 },
  detailVal: { fontWeight: '800', color: colors.ink, fontSize: 14 },
  card: {
  ...
  cardTitle: { fontWeight: '900', fontSize: 16, color: colors.ink, marginBottom: 10 },
  cardTitleDesk: { fontSize: 14, marginBottom: 8 },
  desc: { fontSize: 15, lineHeight: 22, color: colors.ink, fontWeight: '600' },
  descDesk: { fontSize: 14, lineHeight: 20 },
  ingRow: {
    flexDirection: 'row', justifyContent: 'space-between', gap: 12,
    paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: colors.line,
  },
  ingName: { fontWeight: '700', color: colors.ink, flex: 1 },
  ingNameDesk: { fontSize: 14 },
  ingAmt: { color: colors.muted, fontWeight: '600', fontSize: 13, flexShrink: 0 },
  planBtn: {
  ...
  editBtnTxt: { color: colors.brand, fontWeight: '800', fontSize: 13 },
  deleteBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
  ...
  deleteBtnTxt: { color: colors.danger, fontWeight: '800', fontSize: 13 },
  deletingOverlay: {
  ...
  modalHint: { fontSize: 13, color: colors.muted, fontWeight: '600', marginBottom: 14, marginTop: 4 },
  ...
  dayBtnTxt: { fontWeight: '800', color: colors.brand, fontSize: 13 },
  dayBtnSub: { fontSize: 11, color: colors.muted, fontWeight: '600', marginTop: 2 },
