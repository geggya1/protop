...
const styles = StyleSheet.create({
  ...
  meta: { color: c.muted, fontWeight: '400', fontSize: 11, textTransform: 'uppercase' },
  title: { marginTop: 6, color: c.ink, fontWeight: '400', fontSize: 16 },
  bodyTxt: { marginTop: 6, color: c.ink, fontWeight: '400', fontSize: 14, lineHeight: 20 },
  foot: { marginTop: 10, color: c.muted, fontWeight: '400', fontSize: 12 },
  thread: {
  ...
  commentInput: {
    ...
    paddingHorizontal: 12, paddingVertical: 10, color: c.ink, fontWeight: '400',
  },
  commentSend: {
