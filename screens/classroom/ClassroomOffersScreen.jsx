...
const styles = StyleSheet.create({
  ...
  desc: { color: c.muted, fontWeight: '400', marginTop: 6, lineHeight: 20 },
  sub: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 8 },
  del: { color: c.danger, fontWeight: '400', fontSize: 12, marginTop: 8 },
