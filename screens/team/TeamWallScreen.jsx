...
const styles = StyleSheet.create({
  ...
  composeTxt: { color: c.muted, fontWeight: '400', fontSize: 14 },
  card: {
  ...
  author: { color: c.ink, fontWeight: '400', fontSize: 14 },
  when: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 1 },
  iconBtn: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: c.surface2,
    alignItems: 'center', justifyContent: 'center',
  },
  title: { color: c.ink, fontWeight: '400', fontSize: 16, marginBottom: 6 },
  ...
  reactCount: { color: c.ink, fontWeight: '400', fontSize: 13 },
  comments: {
  ...
  commentAvatarTxt: { color: c.ink, fontWeight: '400', fontSize: 12 },
  commentBody: { flex: 1 },
  commentMeta: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 2, flexWrap: 'wrap' },
  commentAuthor: { color: c.ink, fontWeight: '400', fontSize: 13 },
  commentWhen: { color: c.muted, fontWeight: '400', fontSize: 11 },
  editLink: { color: c.brand, fontWeight: '400', fontSize: 12 },
  ...
  cancelLink: { color: c.muted, fontWeight: '400', fontSize: 13 },
  saveBtn: {
    alignSelf: 'flex-start',
    backgroundColor: c.accent, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6,
  },
  saveBtnTxt: { color: '#fff', fontWeight: '400', fontSize: 12 },
  ...
  emptySub: { color: c.muted, textAlign: 'center', fontWeight: '400', fontSize: 13 },
});
