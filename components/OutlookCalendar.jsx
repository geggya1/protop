...
const styles = StyleSheet.create({
  ...
  paneAddTxt: { fontSize: 12, fontWeight: '400', color: colors.brand },
  ...
  miniTitle: { flex: 1, textAlign: 'center', fontWeight: '400', fontSize: 12, color: colors.ink },
  miniDowRow: { flexDirection: 'row' },
  miniDow: { flex: 1, textAlign: 'center', fontSize: 9, fontWeight: '400', color: colors.muted },
  ...
  miniNum: { fontSize: 11, fontWeight: '400', color: colors.ink },
  miniNumOut: { color: '#94a3b8' },
  miniNumTodayTxt: { color: '#fff', fontWeight: '400' },
  miniNumSelectedTxt: { color: colors.brand, fontWeight: '400' },
  ...
  todayBtnTxt: { fontWeight: '400', fontSize: 13, color: colors.ink },
  chev: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center' },
  rangeLbl: { fontWeight: '400', fontSize: 15, color: colors.ink, marginLeft: 4 },
  weekNum: { fontWeight: '400', fontSize: 12, color: colors.muted, marginLeft: 8 },
  ...
  viewBtnTxt: { fontWeight: '400', fontSize: 13, color: colors.ink },
  viewMenu: {
  ...
  viewItemTxt: { fontWeight: '400', fontSize: 13, color: colors.ink },
  ...
  slotPlusTxt: { color: colors.brand, fontWeight: '400', fontSize: 12, lineHeight: 14 },
  evBlock: {
    position: 'absolute',
    zIndex: 5,
    paddingLeft: 1,
  ...
  evTime: { fontSize: 10, fontWeight: '400' },
  evTitle: { fontSize: 12, fontWeight: '400' },
  evTitleNarrow: { fontSize: 10, fontWeight: '400' },
  nowLine: {
  ...
  monthHeadTxt: { flex: 1, textAlign: 'center', fontSize: 12, fontWeight: '400', color: colors.ink, textTransform: 'lowercase' },
  ...
  monthNumBtn: {
    alignSelf: 'flex-start', minWidth: 22, height: 22, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4 },
  monthNumToday: { backgroundColor: colors.brand },
  monthNumOn: { borderWidth: 1, borderColor: colors.brand },
  monthNum: { fontWeight: '400', fontSize: 12, color: colors.ink },
  monthNumTodayTxt: { color: '#fff' },
  monthNumOnTxt: { color: colors.brand },
  monthAdd: { color: colors.muted, fontWeight: '400', fontSize: 14 },
  monthChip: { borderRadius: 3, borderWidth: 1, borderLeftWidth: 3, paddingHorizontal: 4, paddingVertical: 1, marginBottom: 2 },
  monthChipTxt: { fontSize: 11, fontWeight: '400' },
  monthMore: { fontSize: 10, fontWeight: '400', color: colors.muted },
});
