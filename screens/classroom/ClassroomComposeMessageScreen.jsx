...
const styles = StyleSheet.create({
  ...
  label: { color: c.ink, fontWeight: '800', fontSize: 12, marginBottom: 6, marginTop: 10 },
  aud: {
  ...
  audTxt: { color: c.ink, fontWeight: '700' },
  ...
  input: {
    backgroundColor: c.surface, borderRadius: 14, padding: 14, color: c.ink, fontWeight: '700',
    borderWidth: 1, borderColor: c.line,
  },
  area: { minHeight: 120, textAlignVertical: 'top' },
  btn: { marginTop: 20, backgroundColor: c.brand, borderRadius: 16, paddingVertical: 16, alignItems: 'center' },
