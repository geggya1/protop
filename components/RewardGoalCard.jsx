...
const styles = StyleSheet.create({
  ...
  meta: { color: colors.muted, fontSize: 12, marginTop: 2, fontWeight: '600' },
  hero: {
    marginTop: 12,
    width: '100%',
    height: 150,
  ...
  desc: { marginTop: 10, color: colors.ink, fontSize: 14, lineHeight: 20, fontWeight: '600' },
  descLarge: { fontSize: 16, lineHeight: 22 },
  progressLbl: { marginTop: 12, fontWeight: '800', color: colors.ink, fontSize: 13 },
  bar: {
  ...
  status: { marginTop: 8, color: colors.ink, fontWeight: '700', fontSize: 13 },
  ...
  levelLink: { marginTop: 2, color: colors.brand, fontWeight: '700', fontSize: 12 },
  claimBtn: {
