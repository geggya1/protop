...
const styles = StyleSheet.create({
  ...
  disclaimerTxt: { flex: 1, color: '#1e3a8a', fontSize: 13, fontWeight: '400', lineHeight: 18 },
  pickBox: {
  ...
  pendingTitle: { fontSize: 15, fontWeight: '400', color: '#92400e' },
  ...
  pendingCardTitle: { fontSize: 14, fontWeight: '400', color: '#0f172a' },
  ...
  pendingDiscardTxt: { fontSize: 13, fontWeight: '400', color: '#64748b' },
  pendingOpenBtn: {
    alignSelf: 'flex-start',
    paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10,
    backgroundColor: '#2563eb',
  },
  pendingOpenTxt: { fontSize: 13, fontWeight: '400', color: '#fff' },
  pickIconWrap: {
    width: 64, height: 64, borderRadius: 20, alignItems: 'center', justifyContent: 'center',
    backgroundColor: '#eff6ff', marginBottom: 4,
  },
  pickTitle: { fontSize: 18, fontWeight: '400', color: '#1a2744', textAlign: 'center' },
  ...
  primaryBtnTxt: { color: '#fff', fontWeight: '400', fontSize: 16 },
  secondaryBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
  ...
  secondaryBtnTxt: { color: '#2563eb', fontWeight: '400', fontSize: 16 },
  centerBox: { alignItems: 'center', padding: 40, gap: 12 },
  analyzingTxt: { fontWeight: '400', color: '#0f172a', fontSize: 16 },
  analyzingSub: { color: '#64748b', textAlign: 'center' },
  cancelBtn: {
    alignSelf: 'flex-start', marginTop: 16, paddingVertical: 10, paddingHorizontal: 20 },
  cancelBtnTxt: { color: '#64748b', fontWeight: '400' },
  addManualBtn: {
    alignSelf: 'flex-start',
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    paddingVertical: 12, marginTop: 4,
  },
  addManualTxt: { color: '#2563eb', fontWeight: '400', fontSize: 15 },
  summaryCard: {
  ...
  summaryType: { fontWeight: '400', color: '#2563eb', fontSize: 14 },
  summaryTypeError: { color: '#c2410c' },
  summaryTxt: { color: '#334155', marginTop: 8, lineHeight: 20 },
  summaryMeta: { color: '#94a3b8', fontWeight: '400', marginTop: 8, fontSize: 12 },
  ...
  retryBtnTxt: { color: '#2563eb', fontWeight: '400', fontSize: 14 },
  itemCard: {
  ...
  periodTitle: { fontWeight: '400', color: '#0f172a', fontSize: 15 },
  periodHint: { color: '#64748b', fontSize: 12, fontWeight: '400', lineHeight: 17 },
  aiPeriodBanner: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: '#eef6ff', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8,
  },
  aiPeriodTxt: { flex: 1, color: '#0b3d91', fontWeight: '400', fontSize: 12 },
  ...
  choiceTitle: { fontWeight: '400', fontSize: 15, color: '#0f172a' },
  choiceSub: { color: '#64748b', fontSize: 12, fontWeight: '400', marginTop: 2, lineHeight: 17 },
  periodChip: {
    flex: 1, alignItems: 'center', paddingVertical: 10, paddingHorizontal: 6,
    borderRadius: 12, backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e5e7eb',
  },
  periodChipOn: { backgroundColor: '#eef6ff', borderColor: '#2563eb' },
  periodChipTxt: { fontWeight: '400', fontSize: 13, color: '#0f172a' },
  periodChipTxtOn: { color: '#2563eb' },
  periodChipSub: { fontSize: 10, fontWeight: '400', color: '#94a3b8', marginTop: 2 },
  periodChipSubOn: { color: '#3b82f6' },
  periodCustom: { marginTop: 4, gap: 6 },
  periodFieldLabel: { fontWeight: '400', fontSize: 12, color: '#334155', marginTop: 4 },
  periodInput: {
    borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 10, paddingHorizontal: 12,
    paddingVertical: 10, fontSize: 15, fontWeight: '400', backgroundColor: '#f8fafc', color: '#0f172a',
  },
  periodDateBtn: {
    alignSelf: 'flex-start',
  ...
  periodDateTxt: { flex: 1, fontWeight: '400', fontSize: 14, color: '#0f172a' },
  webDateOverlay: {
    position: 'absolute', left: 0, top: 0, width: '100%', height: '100%',
    opacity: 0, cursor: 'pointer', border: 'none', backgroundColor: 'transparent',
  },
  periodSummaryLine: { color: '#2563eb', fontWeight: '400', fontSize: 12, marginTop: 4 },
  groupTitle: {
    fontWeight: '400', fontSize: 13, color: '#64748b', marginTop: 8, marginBottom: 6,
    textTransform: 'uppercase', letterSpacing: 0.4,
  },
  dayGroup: { marginBottom: 4 },
  dayGroupTitle: {
    fontWeight: '400', fontSize: 15, color: '#0f172a', marginTop: 12, marginBottom: 8,
  ...
  prepBannerTitle: { fontWeight: '400', color: '#0b3d91', fontSize: 14 },
  prepBannerSub: { color: '#1e40af', fontSize: 12, fontWeight: '400', marginTop: 2, lineHeight: 17 },
  ...
  subjectChipTxt: { fontWeight: '400', fontSize: 12, color: '#334155' },
