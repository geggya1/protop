...
const styles = StyleSheet.create({
  ...
  deskNavLbl: { fontWeight: '800', color: colors.ink, fontSize: 14, minWidth: 88, textAlign: 'center' },
  ...
  segTxt: { fontWeight: '700', color: colors.ink, fontSize: 12 },
  segTxtOn: { color: '#fff' },
  ...
  navLbl: { fontWeight: '700', color: colors.ink, fontSize: 12, flex: 1, textAlign: 'center', marginHorizontal: 6 },
  todayJump: { alignSelf: 'center', marginBottom: 8, paddingVertical: 4, paddingHorizontal: 10 },
  todayJumpTxt: { color: colors.brand, fontWeight: '800', fontSize: 12 },
  syncBanner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  weekColDow: { fontSize: 10, fontWeight: '800', color: colors.muted, textTransform: 'uppercase' },
  weekColDowToday: { color: colors.brand },
  weekColNum: { fontSize: 16, fontWeight: '900', color: colors.ink, marginTop: 1 },
  ...
  weekEventTime: { fontSize: 10, fontWeight: '800', color: colors.brand },
  weekEventTitle: { fontSize: 12, fontWeight: '700', color: colors.ink, marginTop: 1 },
  weekAdd: { alignItems: 'center', paddingVertical: 4, marginTop: 2 },
  weekAddTxt: { color: colors.brand, fontWeight: '800', fontSize: 16 },
  monthBoard: {
  ...
  monthNum: { fontWeight: '800', fontSize: 12, color: colors.ink, marginBottom: 4 },
  monthNumToday: { color: colors.brand },
  monthChip: { borderRadius: 3, paddingHorizontal: 4, paddingVertical: 2, marginBottom: 2 },
  monthChipTxt: { color: '#fff', fontSize: 10, fontWeight: '700' },
  monthMore: { fontSize: 10, fontWeight: '700', color: colors.muted, marginTop: 2 },
  weekHead: { flexDirection: 'row', marginBottom: 2 },
  wh: { flex: 1, textAlign: 'center', fontWeight: '700', color: colors.muted, fontSize: 10 },
  whToday: { color: colors.brand, fontWeight: '900' },
  ...
  cellNum: { fontWeight: '800', color: colors.ink, fontSize: 13 },
  cellNumOn: { color: '#fff' },
  ...
  listSection: {
    fontSize: 10, fontWeight: '800', color: colors.muted, textTransform: 'uppercase',
  ...
  rowTime: { fontWeight: '800', color: colors.ink, fontSize: 12 },
  rowTimeEnd: { fontWeight: '600', color: colors.muted, fontSize: 10, marginTop: 1 },
  rowTitle: { fontWeight: '700', color: colors.ink, fontSize: 14, flexShrink: 1 },
  ...
  privatePillTxt: { fontSize: 10, fontWeight: '700', color: colors.muted, flexShrink: 1 },
  rowSub: { color: colors.muted, fontWeight: '500', fontSize: 11, marginTop: 1 },
  avatarSlot: { flexShrink: 0, marginLeft: 2 },
  emptyDay: { textAlign: 'center', color: colors.muted, fontWeight: '600', fontSize: 13, paddingVertical: 16 },
  ...
  mealDay: { fontWeight: '800', color: colors.ink, fontSize: 14 },
  mealDayToday: { color: colors.brand },
  mealTodayBadge: {
    backgroundColor: colors.brand, color: '#fff', fontSize: 10, fontWeight: '900',
  ...
  pillTxt: { color: colors.brand, fontWeight: '700', fontSize: 11 },
  mealTitle: { fontWeight: '600', fontSize: 14, color: colors.ink },
  mealMeta: { color: colors.muted, fontWeight: '600', fontSize: 12 },
  mealIngredients: { color: colors.brand, fontWeight: '700', fontSize: 12 },
  mealTapHint: { color: colors.muted, fontWeight: '600', fontSize: 11, marginTop: 2 },
  ...
  portionLbl: { fontWeight: '800', fontSize: 11, color: colors.muted, marginBottom: 4 },
  portionInput: {
    borderWidth: 1, borderColor: colors.line, borderRadius: 10, padding: 8,
    fontSize: 14, backgroundColor: colors.card, fontWeight: '700',
  },
  aiHint: { color: colors.muted, fontSize: 12, fontWeight: '600', lineHeight: 17 },
  ...
  shareBtn: { marginTop: 8, backgroundColor: colors.accent, borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
