...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '400', marginTop: 12, color: '#0f172a', textAlign: 'center' },
  ...
  linkBtn: {
    alignSelf: 'flex-start', marginTop: 14, padding: 10 },
  linkText: { color: '#2563eb', fontSize: 15, fontWeight: '400' },
