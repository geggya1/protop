...
const styles = StyleSheet.create({
  ...
  lead: { color: c.muted, fontWeight: '400', fontSize: 13, marginBottom: 12 },
  emptyBox: {
  ...
  empty: { marginTop: 6, color: c.muted, textAlign: 'center', fontWeight: '400' },
  card: {
    backgroundColor: c.surface, borderRadius: 14, padding: 14, marginBottom: 10,
    borderWidth: 1, borderColor: c.line,
  },
  name: { color: c.ink, fontWeight: '400', fontSize: 16 },
  meta: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 4 },
