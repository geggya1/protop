...
const styles = StyleSheet.create({
  ...
  secondaryBtnTxt: { color: colors.brand, fontWeight: '600', fontSize: 13 },
  ...
  selectLink: { color: colors.brand, fontWeight: '600', fontSize: 13 },
  ...
  ideasTitle: { fontSize: 13, fontWeight: '600', color: colors.ink },
  ideaCard: {
    backgroundColor: colors.brandSoft, borderRadius: 10, padding: 10, gap: 2,
  },
  ideaTitle: { fontSize: 14, fontWeight: '600', color: colors.ink },
