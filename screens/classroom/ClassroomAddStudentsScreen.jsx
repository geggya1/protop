...
const styles = StyleSheet.create({
  ...
  lead: { color: c.muted, fontWeight: '400', fontSize: 14, lineHeight: 20, marginBottom: 12 },
  area: {
    minHeight: 180, backgroundColor: c.surface, borderRadius: 16, padding: 14,
    color: c.ink, fontWeight: '400', borderWidth: 1, borderColor: c.line,
  },
  count: { marginTop: 12, color: c.brand, fontWeight: '400' },
  preview: { color: c.ink, fontWeight: '400', marginTop: 4 },
  hint: { color: c.muted, fontWeight: '400', marginTop: 8, lineHeight: 18 },
  primary: {
  ...
  doneLead: { color: c.ink, fontWeight: '400', fontSize: 18, textAlign: 'center' },
});
