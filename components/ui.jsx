...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: '400', color: baseColors.ink },
  titleDesktop: { fontWeight: '400', letterSpacing: -0.2 },
  ...
  bigBtnTxt: { color: '#fff', fontWeight: '400', fontSize: 18 },
  bigBtnTxtDesktop: { fontSize: 14, fontWeight: '400' },
