...
const styles = StyleSheet.create({
  ...
  kicker: { fontSize: 11, fontWeight: '400', color: c.sensitive, letterSpacing: 0.6, textTransform: 'uppercase' },
  ...
  tabLock: { opacity: 0.7 },
  tabTxt: { color: c.muted, fontWeight: '400', fontSize: 12 },
  ...
  cardTitle: { color: c.ink, fontWeight: '400', fontSize: 16 },
  cardBody: { color: c.ink, fontWeight: '400', marginTop: 6, lineHeight: 20 },
  cardFoot: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 8 },
  auditHead: { marginTop: 18, color: c.ink, fontWeight: '400', fontSize: 13, marginBottom: 6 },
  auditLine: { color: c.muted, fontWeight: '400', fontSize: 11, marginBottom: 4 },
  backdrop: { flex: 1, backgroundColor: 'rgba(26,39,68,0.45)', justifyContent: 'flex-end' },
  sheet: {
    backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20,
    padding: 20, paddingBottom: 28,
  },
  sheetTitle: { fontSize: 20, fontWeight: '400', color: c.ink, marginBottom: 10 },
  input: {
    backgroundColor: c.bg, borderRadius: 14, padding: 12, color: c.ink, fontWeight: '400',
  ...
  aclLead: { color: c.muted, fontWeight: '400', fontSize: 13, lineHeight: 19, marginBottom: 12 },
  aclBlock: { marginBottom: 14 },
  aclName: { color: c.ink, fontWeight: '400', marginBottom: 6 },
  ...
  chipTxt: { color: c.muted, fontWeight: '400', fontSize: 11 },
  chipTxtOn: { color: c.brand },
  pick: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 4 },
  pickTxt: { color: c.ink, fontWeight: '400', fontSize: 13 },
});
