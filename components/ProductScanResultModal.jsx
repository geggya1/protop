...
const styles = StyleSheet.create({
  ...
  loadingTxt: { color: colors.muted, fontWeight: '700' },
  errorTitle: { fontWeight: '900', fontSize: 18, color: colors.ink },
  errorBody: { color: colors.muted, textAlign: 'center', lineHeight: 22, fontWeight: '600' },
  ...
  title: { fontWeight: '900', fontSize: 17, color: colors.ink },
  brand: { color: colors.muted, fontWeight: '700', marginTop: 4 },
  meta: { color: colors.muted, fontWeight: '600', fontSize: 12, marginTop: 4 },
  barcode: { color: colors.brand, fontWeight: '800', fontSize: 11, marginTop: 8 },
  notFoundHint: {
    color: colors.muted,
    fontWeight: '600',
    fontSize: 13,
  ...
  secondaryBtnTxt: { color: colors.brand, fontWeight: '900', fontSize: 15 },
  cancelLink: { alignItems: 'center', marginTop: 12, padding: 8 },
  cancelLinkTxt: { color: colors.muted, fontWeight: '700' },
});
