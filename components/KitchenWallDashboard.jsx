...
const styles = StyleSheet.create({
  ...
  hello: { fontSize: 34, fontWeight: '900', color: colors.ink, letterSpacing: -0.5 },
  helloShort: { fontSize: 28 },
  sub: { marginTop: 4, color: colors.muted, fontWeight: '600', fontSize: 15 },
  exitBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: colors.card, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10,
    borderWidth: 1, borderColor: colors.line,
  },
  exitTxt: { fontWeight: '800', color: colors.brand, fontSize: 13 },
  ...
  cardTitle: { flex: 1, fontWeight: '800', color: colors.ink, fontSize: 15 },
  cardBig: { fontSize: 22, fontWeight: '900', color: colors.ink },
  cardMeta: { marginTop: 4, color: colors.muted, fontWeight: '600', fontSize: 13 },
  ...
  eventTime: { width: 72, color: colors.muted, fontWeight: '700', fontSize: 13 },
  eventTitle: { flex: 1, fontWeight: '700', color: colors.ink, fontSize: 15 },
  fairHint: { color: colors.muted, fontSize: 12, fontWeight: '600', marginBottom: 4 },
  fairRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 6 },
  fairName: { width: 72, fontWeight: '700', color: colors.ink, fontSize: 13 },
  fairTrack: {
    flex: 1, height: 10, borderRadius: 6, backgroundColor: '#e2e8f0', overflow: 'hidden',
  },
  fairFill: { height: '100%', borderRadius: 6 },
  fairPct: { width: 48, textAlign: 'right', fontWeight: '800', color: colors.muted, fontSize: 12 },
  ...
  quickLbl: { fontWeight: '800', color: colors.ink, fontSize: 12 },
});
