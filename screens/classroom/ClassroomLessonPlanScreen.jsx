...
const styles = StyleSheet.create({
  ...
  lead: { color: c.muted, fontWeight: '400', fontSize: 13, lineHeight: 19, marginBottom: 10 },
  ...
  chipTxt: { color: c.muted, fontWeight: '400', fontSize: 12 },
  ...
  emptySub: { marginTop: 6, color: c.muted, textAlign: 'center', fontWeight: '400' },
  card: {
    backgroundColor: c.surface, borderRadius: 16, padding: 14, marginBottom: 10,
    borderWidth: 1, borderColor: c.line,
  },
  meta: { color: c.tint, fontWeight: '400', fontSize: 11, textTransform: 'uppercase' },
  title: { color: c.ink, fontWeight: '400', fontSize: 17, marginTop: 4 },
  obj: { color: c.ink, fontWeight: '400', fontSize: 13, lineHeight: 20 },
  bodyTxt: { color: c.muted, fontWeight: '400', marginTop: 8, lineHeight: 20 },
  teacher: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 8 },
  del: { marginTop: 8, alignSelf: 'flex-start' },
  delTxt: { color: c.danger, fontWeight: '400', fontSize: 12 },
