...
const styles = StyleSheet.create({
  ...
  calloutTxt: { flex: 1, fontWeight: '700', fontSize: 13, color: colors.text || '#0f172a', lineHeight: 18 },
  progressHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  progressTitle: { fontWeight: '800', fontSize: 15, color: colors.text || '#0f172a' },
  progressPct: { fontWeight: '700', color: colors.brand, fontSize: 14 },
  progressBar: {
  ...
  rowTitle: { fontWeight: '800', fontSize: 15, color: colors.text || '#0f172a' },
  dot: { width: 8, height: 8, borderRadius: 4 },
  dotOk: { backgroundColor: '#15803d' },
  dotWarn: { backgroundColor: '#b45309' },
  rowSub: { fontSize: 12, color: colors.muted, marginTop: 2 },
  rowWarn: { fontSize: 11, color: '#9a3412', fontWeight: '600', marginTop: 2 },
  ...
  primaryBtnTxt: { color: '#fff', fontWeight: '800', fontSize: 12 },
  ...
  link: { color: colors.brand, fontWeight: '700', fontSize: 13, textDecorationLine: 'underline' },
  icalToggle: { color: colors.muted, fontWeight: '600', fontSize: 13, textDecorationLine: 'underline' },
  universalIcal: { gap: 8, marginTop: 4 },
  universalLabel: { fontSize: 12, fontWeight: '700', color: '#9a3412' },
  universalInput: {
    borderWidth: 1, borderColor: '#e2e8f0', borderRadius: radius.md,
  ...
  universalBtnTxt: { color: '#fff', fontWeight: '800' },
  syncAllBtn: {
  ...
  syncAllTxt: { color: colors.brand, fontWeight: '800', fontSize: 14 },
});
