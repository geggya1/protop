...
const styles = StyleSheet.create({
  ...
  hubTitle: { fontSize: 22, fontWeight: '400', color: colors.ink, marginBottom: 10 },
  backRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 10 },
  backTxt: { color: colors.brand, fontWeight: '400', fontSize: 14 },
  statusBanner: {
  ...
  inviteStatus: { color: colors.muted, fontWeight: '400' },
  playersRow: {
  ...
  playerName: { flex: 1, fontWeight: '400', color: colors.ink, fontSize: 13 },
  vs: { fontWeight: '400', color: colors.muted },
