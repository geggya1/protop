...
const styles = StyleSheet.create({
  ...
  periodCol: { width: 84 },
  periodLbl: { fontWeight: '400', fontSize: 13, color: colors.ink },
  ...
  clothingTitle: { fontWeight: '400', fontSize: 13, color: '#92400e' },
  clothingTitleCompact: { fontSize: 12 },
  clothingLine: { fontWeight: '400', fontSize: 13, color: '#92400e', lineHeight: 18, paddingLeft: 4 },
