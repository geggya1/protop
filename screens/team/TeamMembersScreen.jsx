...
const styles = StyleSheet.create({
  ...
  bannerTxt: { color: c.ink, fontWeight: '700', fontSize: 13, lineHeight: 18 },
  ...
  modeChipTxt: { color: c.brand, fontWeight: '800', fontSize: 12 },
  ...
  errTiny: { color: '#b45309', fontWeight: '700', fontSize: 11, marginTop: 3 },
  okTiny: { color: c.tint, fontWeight: '600', fontSize: 11, marginTop: 3 },
  resendBtn: {
