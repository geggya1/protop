...
const styles = StyleSheet.create({
  ...
  heading: { color: c.ink, fontWeight: '400', fontSize: 18, textTransform: 'capitalize' },
  ...
  modeTxt: { color: c.muted, fontWeight: '400', fontSize: 12 },
  ...
  ghostTxt: { color: c.ink, fontWeight: '400' },
  dayBlock: { marginBottom: 14 },
  dayLabel: { color: c.ink, fontWeight: '400', fontSize: 13, marginBottom: 6, textTransform: 'capitalize' },
  emptyTiny: { color: c.muted, fontWeight: '400', marginLeft: 4 },
  slot: {
  ...
  slotTitle: { color: c.ink, fontWeight: '400', fontSize: 14 },
  slotMeta: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 1 },
  monthRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: c.surface, borderRadius: 12, padding: 14, marginBottom: 8,
    borderWidth: 1, borderColor: c.line,
  },
  monthName: { flex: 1, color: c.ink, fontWeight: '400', textTransform: 'capitalize' },
  monthCount: { color: c.muted, fontWeight: '400', fontSize: 12 },
  backdrop: { flex: 1, backgroundColor: 'rgba(26,39,68,0.45)', justifyContent: 'flex-end' },
  sheet: {
    backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20,
    padding: 20, maxHeight: '88%',
  },
  sheetTitle: { fontSize: 20, fontWeight: '400', color: c.ink, marginBottom: 8 },
  label: { color: c.ink, fontWeight: '400', fontSize: 12, marginBottom: 6, marginTop: 8 },
  input: {
    backgroundColor: c.bg, borderRadius: 14, padding: 12, color: c.ink, fontWeight: '400',
    borderWidth: 1, borderColor: c.line,
  },
  hint: { color: c.muted, fontWeight: '400', fontSize: 12, marginVertical: 10 },
