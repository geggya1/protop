...
const styles = StyleSheet.create({
  ...
  weekRange: { fontWeight: '400', fontSize: 14, color: colors.ink },
  ...
  typeLbl: { fontSize: 10, fontWeight: '400', color: colors.muted },
  dayLbl: { fontSize: 10, fontWeight: '500', color: colors.muted, textAlign: 'center' },
  dayNum: { fontSize: 12, fontWeight: '400', color: colors.ink, textAlign: 'center' },
  dayLblToday: { color: colors.brand, fontWeight: '400' },
  dayNumToday: { color: colors.brand },
  todayBadge: {
    marginTop: 1, alignSelf: 'center', overflow: 'hidden',
    backgroundColor: colors.brand, color: '#fff',
    fontSize: 8, fontWeight: '400', textAlign: 'center',
  ...
  todayTag: { fontWeight: '400', fontSize: 12, color: colors.brand, marginBottom: 6 },
  todayMeal: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  todayEmoji: { fontSize: 24 },
  todayTitle: { fontWeight: '400', fontSize: 14, color: colors.ink },
  ...
  recipeTitle: { fontWeight: '400', fontSize: 14, color: colors.ink, marginTop: 1 },
  ...
  dayBtnTxt: { fontWeight: '400', color: colors.brand, fontSize: 12 },
  ...
  tagTxt: { fontWeight: '400', color: colors.brand, fontSize: 12 },
  tagTxtOn: { color: '#fff' },
  ...
  formContinueTxt: { color: '#fff', fontWeight: '400', fontSize: 13 },
  pickRow: {
