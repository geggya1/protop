...
const styles = StyleSheet.create({
  ...
  weekPlanDayLbl: { fontSize: 11, color: soft.muted, fontFamily: sans, fontWeight: '600' },
  ...
  headTitle: { fontSize: 13, color: soft.ink, fontFamily: sans, fontWeight: '700', flex: 1 },
  ...
  appLbl: { fontSize: 10, color: soft.muted, fontFamily: sans, fontWeight: '600' },
  ...
  folderLbl: { fontSize: 11, color: soft.ink, fontFamily: sans, fontWeight: '700', textAlign: 'center' },
  timeline: {
    flex: 1,
    alignSelf: 'stretch',
    width: '100%',
  ...
  tlTime: { width: 48, fontSize: 12, color: soft.ink, fontFamily: sans, fontWeight: '600' },
  tlTimeCompact: { width: 44, fontSize: 11 },
  tlTitle: { flex: 1, fontSize: 13, color: soft.ink, fontFamily: sans, fontWeight: '600' },
