...
const styles = StyleSheet.create({
  ...
  hubTitle: { fontSize: 22, fontWeight: '600', color: colors.ink, marginBottom: 4 },
  ...
  secondaryTxt: { color: colors.brand, fontWeight: '600', fontSize: 14 },
  ...
  qText: { fontSize: 19, fontWeight: '700', color: colors.ink, textAlign: 'center', marginBottom: 4 },
  optGrid: { gap: 10 },
  ...
  optTxt: { color: '#fff', fontWeight: '700', fontSize: 16, textAlign: 'center' },
  resultHint: { textAlign: 'center', color: colors.ink, fontWeight: '600', marginTop: 4, fontSize: 15 },
  scoreBoard: {
    backgroundColor: colors.card, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth,
  ...
  scorePts: { fontWeight: '800', color: colors.brand, fontSize: 17 },
