...
const styles = StyleSheet.create({
  ...
  tileTitle: { flex: 1, fontWeight: '400', fontSize: 15, color: colors.ink },
  tileTitleDesk: { ...deskType.label, fontSize: 13, fontWeight: '400' },
  tileSub: { marginTop: 3, fontSize: 12, fontWeight: '400', color: colors.muted, lineHeight: 16 },
  ...
  statusTxt: { fontSize: 10, fontWeight: '400', color: colors.muted },
  ...
  panelTitle: { fontWeight: '400', fontSize: 15, color: colors.ink },
  panelTitleDesk: { ...deskType.label, fontSize: 14, fontWeight: '400' },
  panelBody: { marginTop: 6, fontSize: 13, fontWeight: '400', color: colors.ink, lineHeight: 19 },
  panelBodyDesk: { ...deskType.body, marginTop: 4, lineHeight: 18 },
  meta: { marginTop: 4, fontSize: 12, fontWeight: '400', color: colors.muted },
  ...
  link: { color: colors.brand, fontWeight: '400' },
  doc: { marginTop: 12, gap: 10 },
  docH: { fontWeight: '400', fontSize: 15, color: colors.ink, marginTop: 8 },
  ...
  licenseName: { fontWeight: '400', fontSize: 14, color: colors.ink },
  ...
  docBtnTitle: { fontWeight: '400', fontSize: 14, color: colors.brand },
  openedOk: { marginTop: 10, color: colors.success, fontWeight: '400', fontSize: 13 },
  hint: { marginTop: 10, color: colors.warn, fontWeight: '400', fontSize: 13 },
  cta: {
    marginTop: 14,
    alignSelf: 'flex-start',
  ...
  mailTxt: { color: colors.brand, fontWeight: '400', fontSize: 13 },
  notice: { marginTop: 12, color: colors.success, fontWeight: '400', fontSize: 13 },
});
