...
const styles = StyleSheet.create({
  ...
  headerBadgeTxt: { color: '#fff', fontWeight: '400', fontSize: 12 },
  ...
  sectionBadgeTxt: { color: colors.brand, fontWeight: '400', fontSize: 11 },
  row: {
    flexDirection: 'row',
  ...
  rowTitle: { fontWeight: '400', color: colors.ink, fontSize: 14, flex: 1 },
  rowTitleDesk: { fontSize: 13 },
  rowMeta: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 2 },
  rowCat: { fontSize: 11, fontWeight: '400', color: colors.brand },
  countPill: {
    backgroundColor: colors.brandSoft,
    borderRadius: 999,
    paddingHorizontal: 6,
  ...
  countPillTxt: { fontSize: 10, fontWeight: '400', color: colors.brand },
  rowWhen: { fontSize: 11, fontWeight: '400', color: colors.muted, flexShrink: 0 },
  ...
  emptyTxt: { color: colors.muted, fontWeight: '400', fontSize: 14 },
});
