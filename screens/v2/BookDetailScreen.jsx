...
const styles = StyleSheet.create({
  ...
  screenSub: { fontSize: 13, fontWeight: '600', color: colors.muted, marginBottom: 4 },
  sectionTitle: {
  ...
  title: { fontWeight: '900', fontSize: 20, color: colors.ink },
  author: { color: colors.muted, fontWeight: '600', marginTop: 4 },
  ...
  statusTxt: { color: colors.brand, fontWeight: '800', fontSize: 12 },
  ...
  progressLbl: { fontWeight: '700', color: colors.muted, marginTop: 6, fontSize: 13 },
  lbl: { fontWeight: '800', color: colors.ink, fontSize: 13, marginBottom: 6 },
  hint: { color: colors.muted, fontWeight: '600', fontSize: 13, marginBottom: 8 },
  finishHint: {
    color: colors.muted, fontWeight: '600', fontSize: 12, marginTop: 14, marginBottom: 8,
  },
  input: {
  ...
  quickBtnTxt: { color: colors.brand, fontWeight: '800', fontSize: 13 },
  finishBtn: {
  ...
  finishBtnTxt: { color: '#fff', fontWeight: '900', fontSize: 16 },
  reopenBtn: {
  ...
  reopenBtnTxt: { color: colors.brand, fontWeight: '900', fontSize: 15 },
  ...
  reviewBtnTxt: { color: '#fff', fontWeight: '900', fontSize: 14 },
  deleteBtn: {
    marginTop: 8, alignItems: 'center', paddingVertical: 12,
    flexDirection: 'row', justifyContent: 'center', gap: 6,
  },
  deleteBtnTxt: { color: colors.danger, fontWeight: '800' },
});
