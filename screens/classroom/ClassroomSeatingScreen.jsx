...
const styles = StyleSheet.create({
  ...
  empty: { color: c.muted, fontWeight: '600', textAlign: 'center', lineHeight: 18 },
  ...
  planChipTxt: { color: c.ink, fontWeight: '800', fontSize: 14 },
  planChipTxtOn: { color: c.brand },
  planChipMeta: { color: c.muted, fontWeight: '600', fontSize: 11, marginTop: 2 },
  editor: {
  ...
  planTitle: { color: c.ink, fontWeight: '900', fontSize: 18 },
  planMeta: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 2 },
  editToggle: {
  ...
  editToggleTxt: { color: c.brand, fontWeight: '800', fontSize: 12 },
  ...
  toolTxt: { color: c.brand, fontWeight: '800', fontSize: 12 },
  resizeRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
  resizeLbl: { color: c.muted, fontWeight: '800', fontSize: 12, marginRight: 4 },
  resizeBtn: {
    backgroundColor: c.bg, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6,
    borderWidth: 1, borderColor: c.line,
  },
  resizeTxt: { color: c.ink, fontWeight: '700', fontSize: 12 },
  frontBar: {
    backgroundColor: c.stripe, borderRadius: 10, paddingVertical: 8, alignItems: 'center',
    marginBottom: 8,
  },
  frontTxt: { color: '#fff', fontWeight: '900', letterSpacing: 1, fontSize: 12 },
  room: {
  ...
  teacherTxt: { color: c.brand, fontWeight: '800', fontSize: 11 },
  slotsGrid: {
  ...
  slotTxt: { color: c.muted, fontWeight: '700', fontSize: 10, textAlign: 'center' },
  slotTxtFilled: { color: c.ink },
  deletePlan: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
    paddingVertical: 12, marginTop: 4,
  },
  deletePlanTxt: { color: c.danger, fontWeight: '700', fontSize: 13 },
  ...
  input: {
    backgroundColor: c.bg, borderRadius: 14, padding: 14, color: c.ink, fontWeight: '700',
    borderWidth: 1, borderColor: c.line, marginBottom: 12,
  },
  label: { color: c.ink, fontWeight: '800', fontSize: 12, marginBottom: 8 },
  presetCard: {
  ...
  presetName: { color: c.ink, fontWeight: '800', fontSize: 15 },
  presetDesc: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 2, lineHeight: 16 },
  ...
  sizeX: { color: c.muted, fontWeight: '900', fontSize: 16 },
  save: {
