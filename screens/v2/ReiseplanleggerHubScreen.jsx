...
const styles = StyleSheet.create({
  ...
  tripTitle: { fontSize: 17, fontWeight: '700', color: colors.ink },
  tripDates: { fontSize: 13, color: colors.muted, marginTop: 2 },
  tripRoute: { fontSize: 14, color: '#0f766e', fontWeight: '600' },
  ...
  countdown: { fontSize: 11, fontWeight: '700', color: SUN },
  emptyBox: {
    alignItems: 'center',
    padding: 24,
    gap: 6,
  ...
  emptyTitle: { fontSize: 16, fontWeight: '700', color: colors.ink, marginTop: 6 },
  backRow: { flexDirection: 'row', alignItems: 'center', gap: 2, marginBottom: 8 },
  backTxt: { color: ACCENT, fontWeight: '600', fontSize: 14 },
  cover: {
    width: '100%',
    height: 160,
    borderRadius: 18,
  ...
  nowNextKicker: {
    fontSize: 11, fontWeight: '700', letterSpacing: 0.5, color: '#c2410c', textTransform: 'uppercase',
  },
  nowNextTitle: { fontSize: 18, fontWeight: '700', color: colors.ink, marginTop: 2 },
  ...
  readerBadgeTxt: { fontSize: 13, color: colors.muted, fontWeight: '600' },
  destCard: {
  ...
  destName: { fontSize: 16, fontWeight: '700', color: colors.ink },
  destSub: { fontSize: 12, color: colors.muted, marginTop: 1 },
  destDates: { fontSize: 12, color: '#0f766e', fontWeight: '600', marginTop: 2 },
  ...
  pillBtnTxt: { color: '#fff', fontSize: 12, fontWeight: '700' },
  itemRow: {
  ...
  itemCode: { fontSize: 12, color: SUN, fontWeight: '600', marginTop: 2 },
  itemLink: { fontSize: 13, color: colors.brand, marginTop: 2, fontWeight: '600' },
  ...
  dayLabel: { fontSize: 14, fontWeight: '700', color: colors.ink },
  ...
  pastCollapseTxt: { fontSize: 13, color: PAST_INK, fontWeight: '600' },
  linkBtn: { fontSize: 13, color: ACCENT, fontWeight: '700' },
  dangerBtn: { alignItems: 'center', padding: 14, marginTop: 20 },
  ...
  placeOk: { marginTop: 6, fontSize: 12, color: '#0f766e', fontWeight: '600' },
  ...
  clearDates: { fontSize: 13, color: ACCENT, fontWeight: '600' },
  ...
  typeChipTxt: { fontSize: 12, fontWeight: '600', color: colors.muted },
  ...
  roleToggleTxt: { fontSize: 12, fontWeight: '700', color: '#0f766e' },
});
