...
const styles = StyleSheet.create({
  ...
  modeSub: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 2, lineHeight: 17 },
  ...
  hint: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 6, lineHeight: 17 },
  warn: { color: '#b45309', fontWeight: '700', fontSize: 12, marginTop: 4 },
  adminToggle: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    backgroundColor: c.surface, borderRadius: 12, padding: 14, marginTop: 14,
  },
  adminToggleOn: { borderWidth: 1, borderColor: c.brand },
  adminTxt: { color: c.ink, fontWeight: '700', fontSize: 14, flex: 1 },
  primary: {
  ...
  doneLead: { color: c.ink, fontWeight: '700', fontSize: 15, textAlign: 'center', lineHeight: 22 },
  doneCred: { color: c.brand, fontWeight: '900', fontSize: 28 },
  doneHint: { color: c.muted, fontWeight: '600', fontSize: 13, textAlign: 'center', marginBottom: 8, lineHeight: 19 },
  codeBox: {
  ...
  codeLabel: { color: c.muted, fontWeight: '800', fontSize: 11, textTransform: 'uppercase' },
  codeValue: { color: c.brand, fontWeight: '900', fontSize: 28, letterSpacing: 3, marginTop: 4 },
});
