...
const styles = StyleSheet.create({
  ...
  listSection: {
    fontSize: 10, fontWeight: '600', color: colors.muted, textTransform: 'uppercase',
  ...
  childName: { fontWeight: '600', fontSize: 14, color: colors.ink },
  ...
  countRingTxt: { fontWeight: '700', fontSize: 12, color: colors.brand },
  ...
  addLinkTxt: { color: colors.brand, fontWeight: '600', fontSize: 13 },
  bookRow: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
  ...
  bookTitle: { fontWeight: '600', fontSize: 13, color: colors.ink },
  bookAuthor: { color: colors.muted, fontWeight: '500', fontSize: 11, marginTop: 1 },
  bookStatus: { color: colors.brand, fontWeight: '600', fontSize: 10, marginTop: 3 },
  bookStars: { color: colors.star, fontWeight: '600', fontSize: 11, marginTop: 2, letterSpacing: 0.5 },
  parentIcon: {
  ...
  progressTxt: { fontSize: 10, fontWeight: '600', color: colors.muted, minWidth: 28 },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32, gap: 8 },
  emptyIcon: { fontSize: 48 },
  emptyTitle: { fontWeight: '700', fontSize: 18, color: colors.ink },
