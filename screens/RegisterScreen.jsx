...
const styles = StyleSheet.create({
  ...
  sub: { color: colors.muted, fontWeight: '600', marginBottom: 16, lineHeight: 20 },
  inviteBox: {
  ...
  inviteTitle: { fontSize: 18, fontWeight: '900', color: colors.ink },
  inviteSub: { marginTop: 6, fontSize: 13, fontWeight: '600', color: colors.muted, lineHeight: 18 },
  inviteCode: { marginTop: 8, fontWeight: '800', color: colors.brand, fontSize: 13 },
  label: { fontWeight: '800', color: colors.ink, marginTop: 4, marginBottom: 6, fontSize: 13 },
  input: {
    width: '100%',
    borderWidth: 1,
  ...
  errorText: { color: '#b45309', fontWeight: '700', fontSize: 12, marginTop: -4, marginBottom: 8 },
  hint: { fontSize: 12, fontWeight: '600', marginTop: -4, marginBottom: 8, color: colors.muted },
  ok: { color: '#16a34a' },
  bad: { color: '#b45309' },
  pwRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  showBtn: { paddingHorizontal: 8, paddingVertical: 12 },
  showBtnText: { color: colors.brand, fontWeight: '800' },
