...
function makeStyles(simpleUi, contentMax, board) {
  return StyleSheet.create({
    ...
    hostHint: { fontWeight: '600', color: colors.muted, fontSize: simpleUi ? 15 : 13 },
    secretBig: { fontSize: 72, fontWeight: '900', color: colors.success, marginVertical: 4 },
    ...
    numTxt: { fontWeight: '800', color: colors.ink },
    attemptRow: {
    ...
    attemptGuess: { fontWeight: '800', fontSize: 20, width: 32, textAlign: 'center' },
    attemptHint: { fontWeight: '700', color: colors.muted, minWidth: 80, textAlign: 'right' },
    attemptCorrect: { color: colors.success },
    myAttempt: { fontWeight: '600', color: colors.ink, marginBottom: 4, fontSize: 15 },
    ...
    winner: { textAlign: 'center', fontWeight: '800', fontSize: 20, color: colors.success },
