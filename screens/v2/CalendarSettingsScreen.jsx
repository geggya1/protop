...
const styles = StyleSheet.create({
  ...
  titleDesktop: { fontSize: 18, fontWeight: '700', letterSpacing: -0.2 },
  lead: { color: colors.muted, fontWeight: '600', fontSize: 14, lineHeight: 20, marginBottom: 16 },
  ...
  empty: { color: colors.muted, fontWeight: '600', fontSize: 14, paddingVertical: 4 },
  connRow: {
  ...
  connTitle: { fontWeight: '800', fontSize: 14, color: colors.ink },
  connSub: { fontSize: 12, color: colors.muted, fontWeight: '600', marginTop: 1 },
  connWarn: { fontSize: 12, color: '#b45309', fontWeight: '700', marginTop: 4 },
  connErr: { fontSize: 12, color: colors.danger, fontWeight: '600', marginTop: 4, lineHeight: 16 },
  ...
  reconnectTxt: { color: colors.brand, fontWeight: '800', fontSize: 13 },
  removeBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 8, paddingHorizontal: 8 },
  ...
  oauthBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 6 },
  oauthDisabled: { opacity: 0.55 },
  oauthTitle: { fontWeight: '800', fontSize: 15, color: colors.ink },
  oauthSub: { fontSize: 12, color: colors.muted, fontWeight: '600', marginTop: 2 },
  ...
  privacyTxt: { flex: 1, color: colors.muted, fontSize: 12, fontWeight: '600', lineHeight: 17 },
  setupBox: {
    marginBottom: 8, padding: 12, borderRadius: radius.md,
    backgroundColor: '#fff7ed', borderWidth: 1, borderColor: '#fdba74', gap: 6,
  },
  setupTitle: { fontWeight: '800', fontSize: 14, color: '#9a3412' },
  setupTxt: { fontSize: 12, fontWeight: '600', color: '#9a3412', lineHeight: 17 },
  setupStep: { fontSize: 12, fontWeight: '600', color: '#7c2d12', lineHeight: 17 },
  setupLinks: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 4 },
  setupLink: { color: colors.brand, fontWeight: '800', fontSize: 13 },
  setupOk: {
    marginBottom: 8, padding: 12, borderRadius: radius.md,
    backgroundColor: '#eff6ff', borderWidth: 1, borderColor: '#bfdbfe',
  },
  setupOkTxt: { fontSize: 12, fontWeight: '600', color: '#1e40af', lineHeight: 17 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 },
  infoTitle: { fontSize: 18, fontWeight: '800', color: colors.ink, marginBottom: 8 },
  infoBody: { fontSize: 14, fontWeight: '600', color: colors.muted, textAlign: 'center' },
  ...
  filterChipTxt: { fontWeight: '700', fontSize: 12, color: colors.ink },
