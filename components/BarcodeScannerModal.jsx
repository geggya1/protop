...
const styles = StyleSheet.create({
  ...
  closeBtnTxt: { color: '#fff', fontSize: 18, fontWeight: '400' },
  ...
  manualLinkTxt: { color: '#93c5fd', fontWeight: '400', fontSize: 14 },
  ...
  manualBtnTxt: { color: '#fff', fontWeight: '400' },
  center: {
    flex: 1,
  ...
  permTitle: { color: '#fff', fontSize: 20, fontWeight: '400', marginBottom: 12, textAlign: 'center' },
  permBody: {
  ...
  cancelLinkTxt: { color: '#93c5fd', fontWeight: '400' },
  loadingOverlay: {
    ...StyleSheet.absoluteFillObject,
    alignItems: 'center',
    justifyContent: 'center',
  ...
  loadingTxt: { color: '#fff', marginTop: 12, fontWeight: '400' },
});
