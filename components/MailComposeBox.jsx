...
const styles = StyleSheet.create({
  ...
  kicker: {
    fontSize: 10, fontWeight: '400', color: colors.muted, letterSpacing: 0.5, textTransform: 'uppercase',
  },
  ...
  fieldLbl: { width: 78, fontSize: 12, fontWeight: '400', color: colors.muted },
  ...
  sigLbl: { fontSize: 10, fontWeight: '400', color: colors.muted, textTransform: 'uppercase', marginBottom: 4 },
  sigFallback: { fontSize: 12, color: colors.muted, marginTop: 8, marginBottom: 12 },
  error: { color: colors.danger, fontWeight: '400', fontSize: 12, paddingHorizontal: 16, paddingTop: 8 },
  footer: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    alignItems: 'center',
  ...
  impTxt: { fontSize: 11, fontWeight: '400', color: colors.ink },
});
