...
const styles = StyleSheet.create({
  ...
  lead: { color: c.muted, fontWeight: '400', fontSize: 13, lineHeight: 19, marginBottom: 14 },
  summary: {
    backgroundColor: c.surface, borderRadius: 16, padding: 16, marginBottom: 14,
    borderWidth: 1, borderColor: c.line, alignItems: 'center',
  },
  summaryNum: { color: c.brand, fontWeight: '400', fontSize: 32 },
  summaryLbl: { color: c.muted, fontWeight: '400', marginTop: 4 },
  empty: { color: c.muted, fontWeight: '400', textAlign: 'center' },
  emptyTitle: { color: c.ink, fontWeight: '400', fontSize: 16, marginBottom: 6, textAlign: 'center' },
  emptyBox: {
  ...
  rowTitle: { color: c.ink, fontWeight: '400', fontSize: 15 },
  rowMeta: { color: c.muted, fontWeight: '400', fontSize: 12, marginTop: 2 },
  grade: { color: c.brand, fontWeight: '400', fontSize: 15 },
  ...
  corner: { color: c.muted, fontWeight: '400', fontSize: 11, textTransform: 'uppercase' },
  colHead: { width: 72, paddingHorizontal: 4 },
  colHeadTxt: { color: c.ink, fontWeight: '400', fontSize: 11 },
  colHeadPts: { color: c.muted, fontWeight: '400', fontSize: 10, marginTop: 2 },
  nameCell: { color: c.ink, fontWeight: '400', fontSize: 12, paddingHorizontal: 8 },
  cell: { width: 72, alignItems: 'center' },
  cellGrade: { color: c.brand, fontWeight: '400', fontSize: 13 },
});
