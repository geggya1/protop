...
const styles = StyleSheet.create({
  ...
  weatherTemp: { fontSize: 22, fontWeight: '900', color: '#0f1419' },
  weatherTxt: { fontSize: 13, fontWeight: '600', color: '#536471', marginTop: 2 },
  statusBlock: {
  ...
  statusLabel: { fontSize: 14, fontWeight: '700', color: '#0f1419' },
  statusHint: { fontSize: 12, fontWeight: '600', color: '#536471', marginTop: 2 },
  statusValue: { fontSize: 14, fontWeight: '800' },
  eventPeek: { paddingLeft: 42, paddingBottom: 4, gap: 2 },
  eventPeekLine: { fontSize: 12, fontWeight: '600', color: '#536471' },
  tipLine: {
    fontSize: 13,
    fontWeight: '600',
    color: '#536471',
  ...
  yesterdayDetail: { fontSize: 13, fontWeight: '600', color: '#0f1419' },
  yesterdayKid: { fontSize: 12, fontWeight: '600', color: '#536471', paddingLeft: 8 },
  coachBanner: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    gap: 8,
  ...
  coachTxt: { flex: 1, fontSize: 13, fontWeight: '700', lineHeight: 18 },
  btn: {
    marginHorizontal: 22,
    marginTop: 8,
