...
const styles = StyleSheet.create({
  ...
  warnTxt: { flex: 1, color: c.sensitive, fontWeight: '700', fontSize: 13, lineHeight: 18 },
  ...
  avTxt: { color: c.ink, fontWeight: '900' },
  name: { color: c.ink, fontWeight: '800', fontSize: 15 },
  sub: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 2 },
  foot: { color: c.muted, fontWeight: '600', fontSize: 12, marginTop: 12, lineHeight: 18 },
});
