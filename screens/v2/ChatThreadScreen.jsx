...
const styles = StyleSheet.create({
  ...
  backBtn: {
    alignSelf: 'flex-start', padding: 2, marginRight: 2 },
  threadTitle: { fontWeight: '400', fontSize: 15, color: colors.ink },
  threadHint: { fontSize: 10, fontWeight: '400', color: colors.muted, marginTop: 1 },
  ...
  body: { fontSize: 14, color: colors.ink, fontWeight: '400', lineHeight: 20 },
  bodyMine: { color: '#fff' },
  caption: { marginTop: 6, fontSize: 13 },
  imageLabel: { fontSize: 12, opacity: 0.9 },
  editedLbl: { fontSize: 10, fontWeight: '400', color: colors.muted, marginTop: 4, fontStyle: 'italic' },
  ...
  msgActionBtn: {
    alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 4, paddingHorizontal: 2 },
  msgActionTxt: { fontSize: 12, fontWeight: '400', color: colors.brand },
  ...
  deletedTxt: { fontSize: 13, fontWeight: '400', color: '#64748b', fontStyle: 'italic' },
  ...
  editTitle: { fontSize: 17, fontWeight: '400', color: colors.ink },
  editInput: {
